...
@section('content')
<div class="card">
    <div class="card-header" style="font-size: 1.4rem; font-weight: bold; color:blue">
        Post info
    </div>
    <div class="card-body">
        <div>
        ...
        <div>
            <div style="font-size: 1.2rem; font-weight: bold">Description: </div>
            @if($post->description)
...
@if($post->user)
<div class="card">
    <div class="card-header" style="font-size: 1.4rem; font-weight: bold; color:blue">Creator Info</div>
    <div class="card-body">
        <div>
